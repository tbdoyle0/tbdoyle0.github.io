    ...
    datatable(rownames = FALSE, 
            options = list(
              ...
              initComplete = JS(
                ...
                "$('.dataTables_info').css({'font-family': 'Roboto', 'color': '#333', 'font-size': '10px'});",  # Apply font-family to 'Showing X of Y entries'
                "$('.dataTables_paginate').css({'font-family': 'Roboto', 'color': '#333', 'font-size': '10px'});", # Apply font-family to pagination
                "$('.paginate_button').css({'font-family': 'Roboto', 'color': '#333', 'font-size': '10px'});", # Apply font-family to page buttons
                "}"
              )
            )
  ) %>%
