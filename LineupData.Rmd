    ...
    datatable(rownames = FALSE, 
            options = list(
              ...
              initComplete = JS(
                ...
                "if (!document.getElementById('local-font-roboto')) {", 
                "  var style = document.createElement('style');",
                "  style.id = 'local-font-roboto';",
                "  style.type = 'text/css';",
                "  style.textContent = `@font-face { font-family: 'Roboto'; font-style: normal; font-weight: 400; src: url('/path/to/fonts/roboto.woff2') format('woff2'); }`;",
